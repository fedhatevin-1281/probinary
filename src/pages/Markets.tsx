...
export default function Markets({ onTrade }: Props) {
  ...
  const [favs, setFavs] = useState(
    new Set(MARKETS_DATA.filter((m) => m.fav).map((m) => m.symbol)),
  )
    ...
    >
      ...
      >
        <div>
          ...
          <p style={{ fontSize: 13, color: "#52525B", margin: "4px 0 0" }}>
            {MARKETS_DATA.length} synthetic indices · Live prices
          </p>
        </div>
          ...
          {CATS.map((c) => (
            <button
              ...
              style={{
                ...
                padding: "7px 14px",
                background:
                  category === c.id ? "rgba(124,58,237,0.12)" : "transparent",
                border:
                  category === c.id
          ...
          return (
            ...
            >
              ...
              >
                ...
                <Sparkline
                  history={live?.history ?? [market.price]}
                  positive={isUp}
                />
              </div>
      ...
      {filtered.length === 0 && (
        ...
        >
          ...
          <div
            className="font-display"
            style={{ fontSize: 16, fontWeight: 600, color: "#52525B" }}
          >
            No markets found
          </div>
