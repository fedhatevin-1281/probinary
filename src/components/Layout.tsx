...
export default function Layout({
  ...
  const accountBalance =
    activeAccount === "real" ? balances.real : balances.demo
      ...
      >
          ...
          >
            ...
            {!isMobile && (
              <>
                ...
                />
                <HeaderChip
                  label={`Live Chat${unreadChat ? ` (${unreadChat})` : ""}`}
                  icon={<ChatSmallIcon />}
                  onClick={() => openPanel("chat")}
                  active={panel === "chat"}
                  ariaLabel="Open live support chat"
                />
                <HeaderChip
                  label="How to Trade"
                  icon={<BookSmallIcon />}
                  ...
                  active={panel === "learn"}
                  ariaLabel="Open learning center"
                />
              </>
            )}
            ...
            <div ref={balanceRef} style={{ position: "relative" }}>
                ...
                >
                  ...
                  <span
                    className={`font-mono-data ${
                      balancePulse ? "nav-balance-pulse" : ""
                    }`}
                    style={{ fontSize: 11, fontWeight: 600 }}
                  >
                    {formatUsdValue(animatedAccountBalance)}
                  </span>
                </span>
                <ChevronDownMini />
              </button>
              ...
              {balanceMenuOpen && (
                ...
                >
                  ...
                  <button
                    className="nav-feature-secondary"
                    disabled={loadingStates.refreshBalances}
                    onClick={() => void refreshBalances()}
                  >
                    {loadingStates.refreshBalances
                      ? "Refreshing..."
                      : `Refresh (${backendOnline ? "Online" : "Offline"})`}
                  </button>
                </div>
              )}
            </div>
        ...
        {mobileActionsOpen && (
          ...
          >
            ...
            <button className="nav-chip-btn" onClick={() => openPanel("ai")}>
              AI
            </button>
            <button className="nav-chip-btn" onClick={() => openPanel("chat")}>
              Live Chat
            </button>
            <button className="nav-chip-btn" onClick={() => openPanel("learn")}>
              How to Trade
            </button>
            <button
              className="nav-chip-btn"
...
function ChatSmallIcon() {
  return (
    ...
    >
      <path
        d="M20 11a8 8 0 0 1-8 8H7l-4 3 1.3-4.2A8 8 0 1 1 20 11z"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
